...
export default function About() {
  const stats = [
    ...
    { label: 'Nota Fiscal em Vendas', value: '100% de Emissão' },
    { label: 'Selo de Origem', value: 'Garantida' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto pb-16 space-y-4">
          <div className="inline-flex items-center gap-1.5 bg-red-650 text-white px-3 py-1 rounded-sm text-xs font-mono font-bold uppercase tracking-wider italic">
            <Calendar className="h-3.5 w-3.5" /> ESTABILIDADE E TRADIÇÃO REAL
          </div>
          <h2 className="text-3xl md:text-5xl font-display font-extrabold text-stone-950 italic uppercase tracking-tighter">
            AUTO PEÇAS MAX LTDA (MAXPEÇAS)
          </h2>
          <div className="h-1 w-20 bg-red-650 mx-auto" />
          <p className="text-stone-600 text-base md:text-lg">
            Um dos estoques mais robustos e qualificados de Belo Horizonte, com origem comprovada e procedência estrita de frotas e seguradoras.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-stone-700 leading-relaxed text-sm md:text-base">
              Fundada em <strong className="text-stone-900">1995</strong> no coração de Belo Horizonte, a <strong className="text-stone-900">AUTO PECAS MAX LTDA</strong> surgiu com a premissa de oferecer a mecânicos, oficinas e clientes finais uma alternativa segura, econômica e 100% legalizada de reposição automotiva.
            </p>

            <p className="text-stone-700 leading-relaxed text-sm md:text-base">
              Nosso estoque é composto exclusivamente de peças adquiridas em lotes de frotistas e seguradoras parceiras. Todas as peças seminovas passam por uma cuidadosa inspeção visual, higienização rigorosa e testes práticos de funcionamento antes de serem devidamente cadastradas e comercializadas.
            </p>
            ...
            <blockquote className="border-l-4 border-red-600 bg-stone-50 p-4 rounded-r italic text-stone-600 text-sm">
              &quot;Nossa premissa não é simplesmente vender a autopeça mais barata, mas sim assegurar que a peça que entra no seu carro seja original, tenha procedência garantida, nota fiscal autenticada e 3 meses de garantia de funcionamento.&quot; 
              <span className="block mt-2 text-xs font-bold font-mono text-stone-900">— Direção MAXPEÇAS.</span>
            </blockquote>
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-stone-50 border border-stone-150 p-6 rounded-lg space-y-3 relative overflow-hidden group hover:border-red-600 transition-all duration-300">
              ...
              <h4 className="font-display font-bold text-stone-900 text-lg uppercase italic">Nota Fiscal Integral</h4>
              <p className="text-stone-600 text-xs md:text-sm">
                Garantia legal e transações fiscais 100% corretas para sua e nossa segurança tributária.
              </p>
            </div>
            ...
            <div className="bg-stone-50 border border-stone-150 p-6 rounded-lg space-y-3 relative overflow-hidden group hover:border-red-600 transition-all duration-300">
              ...
              <h4 className="font-display font-bold text-stone-900 text-lg uppercase italic">Procedência Verificada</h4>
              <p className="text-stone-600 text-xs md:text-sm">
                Aquisições legalizadas com nota fiscal e documentação de origem totalmente limpa e comprovada.
              </p>
            </div>
